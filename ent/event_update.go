...
func (eu *EventUpdate) SetTransactionID(id string) *EventUpdate {
	eu.mutation.SetTransactionID(id)
	return eu
}
...
func (eu *EventUpdate) SetTransaction(t *Transaction) *EventUpdate {
	return eu.SetTransactionID(t.ID)
}
...
func (eu *EventUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := eu.mutation.TransactionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   event.TransactionTable,
...
func (euo *EventUpdateOne) SetTransactionID(id string) *EventUpdateOne {
	euo.mutation.SetTransactionID(id)
	return euo
}
...
func (euo *EventUpdateOne) SetTransaction(t *Transaction) *EventUpdateOne {
	return euo.SetTransactionID(t.ID)
}
...
func (euo *EventUpdateOne) sqlSave(ctx context.Context) (_node *Event, err error) {
	...
	if nodes := euo.mutation.TransactionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   event.TransactionTable,
